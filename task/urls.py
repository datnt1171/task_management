...
urlpatterns = [
    ...
    path('<uuid:pk>/upload-files/', views.TaskFileUploadView.as_view(), name='task-upload-files'),
    ...
    path('sample-by-factory/', views.SampleByFactoryView.as_view(), name='data-detail'),
